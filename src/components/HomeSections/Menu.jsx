...
export const Menu = ({ isOpen, isAuthenticated, authenticatedUser }) => {
  return (
    <div
    ...
    >
      ...
      >
        {isAuthenticated ? (
          <div className="ml-4 cursor-pointer px-3 p-1 rounded-full bg-red-600 text-white text-2xl border-2 border-black text-center font-bold">
